                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" id="myForm" method="post" action="{{route('update.permission')}}">
                            ...
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1" class="form-label">Permissions Name</label>
...
exampleFormControlSelect1">
                                    ...
                                    <option value="type" {{$permission->group_name == 'type' ? 'selected' : ''}}> Property
                                        Type</option>
                                    ...
                                    <option value="agent" {{$permission->group_name == 'agent' ? 'selected' : ''}}>Manage
                                        Agent</option>
                                    <option value="category" {{$permission->group_name == 'category' ? 'selected' : ''}}>
                                        Blog Category</option>
                                    <option value="post" {{$permission->group_name == 'post' ? 'selected' : ''}}>Blog post
                                    </option>
