...
<link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/
bootstrap-toggle.min.css" rel="stylesheet">
<div class="page-content">

    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <a href="{{route('add.admin')}}" class="btn btn-inverse-info"> Add
                Admin </a>
        </ol>
    </nav>
    <div class="row">
                        ...
                        <tbody>
                            @foreach($alladmin as $key => $item)
                                <tr>
                                    ...
                                    <td> <a href="{{route('edit.admin', $item->id)}}" class="btn btn-inverse-warning"
