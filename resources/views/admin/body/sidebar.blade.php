        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="amenitie">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('all.amenitie') }}" class="nav-link">All Amenitys </a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="amenitie">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('add.services') }}" class="nav-link">Add service</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="emails">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('all.contacts') }}" class="nav-link"> All Contacts Information</a>
                        </li>
