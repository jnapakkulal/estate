    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item">
                <img src="{{ asset('frontend/img/hero-carousel/hero-carousel-2.jpg')}}" alt="">
                <div class="carousel-container">
                    <div>
                        <p>Doral, Florida</p>
            ...
            <div class="carousel-item">
                <img src="{{ asset('frontend/img/hero-carousel/hero-carousel-3.jpg')}}" alt="">
                <div class="carousel-container">
                    <div>
                        <p>Doral, Florida</p>
    ...
    <section id="agents" class="agents section">
        ...
        <div class="container">
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="member">
                        <div class="pic"><img src="{{ asset('frontend/img/team/team-1.jpg')}}" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="member">
                        <div class="pic"><img src="{{ asset('frontend/img/team/team-3.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
