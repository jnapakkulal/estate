        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-1.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-2.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-3.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-4.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-5.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                    <div class="card">
                        <img src="{{asset('frontend/img/properties/property-6.jpg')}}" alt="" class="img-fluid">
                        <div class="card-body">
